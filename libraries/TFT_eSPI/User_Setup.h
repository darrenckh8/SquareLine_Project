...
#define TFT_CS   11  // Chip select control pin (library pulls permanently low
#define TFT_DC   12  // Data Command control pin - must use a pin in the range 0-31
#define TFT_RST  10  // Reset pin, toggles on startup

#define TFT_WR   13  // Write strobe control pin - must use a pin in the range 0-31
...
#define TFT_D2   4  // Pins can be randomly assigned, this does not affect
